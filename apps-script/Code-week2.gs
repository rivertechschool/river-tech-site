...
function doGet(e) {
  ...
  if (params.action === "setupSheet" && params.token === "rtd-w2-bootstrap-fxR8q3") {
...
function sendParentEmail_(registrationId, p) {
  ...
  const body = [
    ...
    "",
    "What happens next:",
    "• Registration is open through Saturday, May 10.",
    "• We'll review your child's subject ratings and match them to the classes they'll most enjoy.",
    "• You'll receive your confirmed schedule on Sunday, May 11.",
